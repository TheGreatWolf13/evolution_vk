...
struct SwapMechanism<T: BufferContents> {
...
impl<T: BufferContents> SwapMechanism<T> {
...
impl<T: BufferContents> GraphicsEngine<T> {
    ...
    pub fn get_framebuffers_and_pipeline(window_size: PhysicalSize<u32>, images: &Vec<Arc<Image>>, render_pass: Arc<RenderPass>, allocator: Arc<StandardMemoryAllocator>, vs: EntryPoint, fs: EntryPoint) -> (Vec<Arc<Framebuffer>>, Arc<GraphicsPipeline>) {
